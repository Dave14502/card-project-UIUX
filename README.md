...
- Run it locally: `npm install` then `npm run dev` from the repo root, open `http://localhost:3000`.
- Repo: Git is on `main` with origin `https://github.com/Dave14502/card-project-landingpage.git`.
